...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar ftco-navbar-light site-navbar-target" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html"><span>A</span>rie</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav nav ml-auto">
	          ...
	          <li class="nav-item"><a href="#resume-section" class="nav-link"><span>Background</span></a></li>
		  				...
		  				<h1>Arie Arifin</h1>
			  				<h2>I'm a
								  <span
								     class="txt-rotate"
								     data-period="2000"
								     data-rotate='[ "Web Developer.", "IT Enthusiast." ]'></span>
								</h2>
							</div>
            </div>
          </div>
    		...
    		<div class="row d-flex no-gutters">
    			...
    			<div class="col-md-6 col-lg-6 pl-md-5 py-5">
		          ...
		          <div class="col-md-12 heading-section ftco-animate">
		            ...
		            <p>I'm a fresh graduate student of Informatics degree, Universitas Islam
              ...
              <div class="text">
                ...
                <p><a href="https://drive.google.com/file/d/1f5k9kpU7vSTncOf27umFub6Wx5h15iTw/view?usp=sharing" class="btn btn-primary py-3 px-3">Download CV</a></p>
              </div>
	          </div>
	        </div>
        </div>
					  ...
					  <div id="page-1" class= "page one">
					    ...
					    <div class="resume-wrap d-flex ftco-animate">
					    	...
					    	<div class="text pl-3">
		    					...
		    					<h2>Bachelor of Informatics in Industrial Technology</h2>
		    					<span class="position">Islamic University of Indonesia</span>
		    					<p>Courses: Information Systems</p>
	    					</div>
	    				</div>
	    				<!-- ?<div class="resume-wrap d-flex ftco-animate"> -->
	    					<!-- <div class="icon d-flex align-items-center justify-content-center"> -->
					  ...
					  <div id="page-2" class= "page two">
					    ...
					    <div class="resume-wrap d-flex ftco-animate">
					    	...
					    	<div class="text pl-3">
		    					...
		    					<h2>Web Developer</h2>
		    					<span class="position">Islamic University of Indonesia</span>
		    					<p>The project was a Final Assignment (TA) for my Bachelor's degree called "Sistem Informasi Akademik PDQ"</p>
		    				</div>
	    				</div>
	    				<!-- <div class="resume-wrap d-flex ftco-animate">
	    					<div class="icon d-flex align-items-center justify-content-center">
    ...
    <section class="ftco-section ftco-project" id="projects-section">
    	<div class="container-fluid px-md-0">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
            ...
            <p>These are few example of projects I've done so far</p>
          </div>
        </div>
    		<div class="row no-gutters">
    			<div class="col-md-4">
    				<div class="project img ftco-animate d-flex justify-content-center align-items-center" style="background-image: url(images/pdq.png);">
    					<div class="overlay"></div>
	    				<div class="text text-center p-4">
	    					<h3><a href="#">UIITaklim</a></h3>
	    					<span>Website</span>
	    				</div>
    				</div>
  				</div>
  				<div class="col-md-4">
    				<div class="project img ftco-animate d-flex justify-content-center align-items-center" style="background-image: url(images/onhealic.png);">
    					<div class="overlay"></div>
	    				<div class="text text-center p-4">
	    					<h3><a href="#">ON-HEALIC</a></h3>
	    					<span>Website</span>
	    				</div>
    				</div>
  				</div>
    			...
    			<div class="col-md-4">
    				<div class="project img ftco-animate d-flex justify-content-center align-items-center" style="background-image: url(images/sparkcare.png);">
    					<div class="overlay"></div>
	    				<div class="text text-center p-4">
	    					<h3><a href="#">SparkCare</a></h3>
			...
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-md-7 ftco-animate text-center">
						<h2>I'm <span>Available</span> for Full-time Job</h2>
						<p>ps: also available for Paid Internship Program ;)</p>
          ...
          <div class="col-md-6 col-lg-4 d-flex ftco-animate">
          	<div class="align-self-stretch box text-center p-4 shadow">
          		...
          		<div>
		            ...
		            <p>Vila Kenali Permai Blok N3 No. 12 Kota Jambi</p>
		          </div>
	          </div>
          </div>
          <div class="col-md-6 col-lg-4 d-flex ftco-animate">
          	<div class="align-self-stretch box text-center p-4 shadow">
          		...
          		<div>
	          		<h3 class="mb-4">Contact Number (Whatsapp)</h3>
		            <p><a href="tel://+6281328018314">+62 813-2801-8314</a></p>
	            </div>
	          </div>
          </div>
          <div class="col-md-6 col-lg-4 d-flex ftco-animate">
          	<div class="align-self-stretch box text-center p-4 shadow">
          		...
          		<div>
		            ...
		            <p><a href="ariearfn@gmail.com">ariearfn@gmail.com</a></p>
		          </div>
	          </div>
          </div>
...
{{--
        <div class="row no-gutters block-9">
          ...
          {{-- <div class="col-md-6 d-flex">
          	<div class="img" style="background-image: url(images/radio.jpg);"></div> --}}
          </div>
        </div>
      </div>
    </section>
